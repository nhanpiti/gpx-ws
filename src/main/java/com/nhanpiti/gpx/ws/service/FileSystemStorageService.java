...
public class FileSystemStorageService implements StorageRepository {
	...
	public String getPathFile(MultipartFile file) {
		return this.rootLocation.toString() + "/" +  StringUtils.cleanPath(file.getOriginalFilename());
	}
