...
public class GpxRepositoryIT {
    ...
    @Test
    public void whenFindAll_thenReturnListingSizeEqual1() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/gpx").contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content()
                        .contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].gpxId", Is.is(1)));
    }
}
